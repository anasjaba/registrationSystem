...
if(isset($_POST['send_my_password'])){
    ...
    if($row = $result->fetch_assoc()){
        ...
        if(mail($email , 'Your Password!!' , "Your password is : $password" , "From: danyal@phpfragments.com")){
          header("Location:forgot_password.php?success=" . urlencode("Your Password has been sent to your email!!"));
            exit();
        }else { header("Location:forgot_password.php?err=" . urlencode("Sorry we could not send you password at this time!!"));
            exit(); }
    }else {
